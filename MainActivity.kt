...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var score = 0
    private val totalQuestion = QuestionAnswer.questions.size
    ...
    private fun loadNewQuestion() {
        ...
        questionTextView.text = QuestionAnswer.questions[currentQuestionIndex]
    ...
    private fun finishQuiz() {
        val passStatus = if (score > totalQuestion * 0.50) "Passed" else "Failed"
